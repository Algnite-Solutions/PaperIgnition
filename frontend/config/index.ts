...
export default defineConfig<'vite'>(async (merge, { command, mode }) => {
  const baseConfig: UserConfigExport<'vite'> = {
    ...
    defineConstants: {
      ...
      'process.env.REACT_APP_DEV_API_BASE_URL': JSON.stringify(process.env.REACT_APP_DEV_API_BASE_URL || 'http://127.0.0.1:9000'),//http://10.0.1.226:8080
      'process.env.REACT_APP_PROD_API_BASE_URL': JSON.stringify(process.env.REACT_APP_PROD_API_BASE_URL || ''),
