...
export default defineConfig<'vite'>(async (merge, { command, mode }) => {
  const baseConfig: UserConfigExport<'vite'> = {
    ...
    defineConstants: {
      ...
      'process.env.REACT_APP_DEV_API_BASE_URL': JSON.stringify(process.env.REACT_APP_DEV_API_BASE_URL || 'http://localhost:8000/api'),
      'process.env.REACT_APP_PROD_API_BASE_URL': JSON.stringify(process.env.REACT_APP_PROD_API_BASE_URL || 'https://your-production-api.com/api'),
      'process.env.REACT_APP_STAGING_API_BASE_URL': JSON.stringify(process.env.REACT_APP_STAGING_API_BASE_URL || 'https://your-staging-api.com/api'),
